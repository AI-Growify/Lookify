  ...
  plans: [
    {
      ...
      cadence: 'Limited Use',
      overage: '',
      features: ['10 monthly try-ons', 'Customizable Try-On Widget'],
      cta: 'Get Started',
      featured: false,
    },
    {
      ...
      features: ['100 monthly try-ons', 'Analytics Dashboard', 'Email Collection', 'Standard Support'],
      cta: 'Get Started',
      featured: false,
    },
    {
      ...
      features: ['350 monthly try-ons', 'Advanced Analytics', 'Email Collection', 'Standard Support'],
      cta: 'Get Started',
      featured: true,
      badge: 'Most Popular',
    },
    {
      ...
      features: ['1,000 monthly try-ons', 'Advanced Analytics', 'Email Collection', 'Priority Support'],
      cta: 'Get Started',
      featured: false,
    },
  ],
